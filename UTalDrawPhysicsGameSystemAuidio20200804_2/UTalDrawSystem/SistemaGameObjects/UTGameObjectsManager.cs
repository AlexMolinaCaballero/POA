...
namespace UTalDrawSystem.SistemaGameObject
{
    public static class UTGameObjectsManager
    {
        ...
        static List<UTGameObject> ToAddUTGameObjects = new List<UTGameObject>();
        ...
        public static void Update(GameTime gameTime)
        {
            ...
            AllUTGameObjects.AddRange(ToAddUTGameObjects);
            ToAddUTGameObjects = new List<UTGameObject>();
        }
